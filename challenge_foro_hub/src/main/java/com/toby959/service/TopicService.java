package com.toby959.service;

import com.toby959.error.TopicNotFoundException;
import com.toby959.models.Topic;
import com.toby959.models.dto.TopicDataDetails;
import com.toby959.models.dto.TopicDataList;
import com.toby959.models.dto.TopicRegistryData;
import com.toby959.models.dto.TopicUpdateData;
import com.toby959.repository.TopicRepository;
...
public class TopicService {
    ...
    public ResponseEntity<String> createTopic(TopicRegistryData topicRegistryData) {
        if (topicRegistryData.title() == null || topicRegistryData.message() == null) {
            return ResponseEntity.badRequest().body("Título y mensaje son requeridos.");
        }
...
//##############################
    ...
    public ResponseEntity<String> updateTopic(Long id, TopicUpdateData topicUpdateData) {
        ...
        if (topicRepository.existsByTitleAndMessage(topicUpdateData.title(), topicUpdateData.message())) {
            return ResponseEntity.badRequest().body("Tópico con ese título y mensaje ya existe!!!");
        }
